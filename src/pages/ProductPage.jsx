      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 24px" }}>
            ...
            >
              {product.price ? (
                ...
                >
                  ...
                  >
                    Precio por consultar en WhatsApp
                  </span>
                </div>
              )}
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              <a
                ...
                style={{
                  ...
                  gap: 8,
                  background: canOrder ? "#25d366" : "#ccc",
                  color: "#fff",
                  borderRadius: 14,
                  padding: "15px 24px",
                  fontFamily: "'Barlow Condensed',sans-serif",
                ...
                onMouseEnter={(e) => {
                  if (canOrder) e.currentTarget.style.transform = "scale(1.02)";
                }}
                onMouseLeave={(e) => {
            ...
            {isCustom && (
              ...
              >
                ...
                <div>
                  ...
                  >
                    Tiempo estimado 12–15 días hábiles. Confirmamos
                    disponibilidad antes de recibir pago.
                  </p>
                </div>
              </div>
            )}
        ...
        <div style={{ marginTop: 48, textAlign: "center" }}>
          <button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.borderColor = "#003893";
              e.currentTarget.style.color = "#003893";
            }}
            onMouseLeave={(e) => {
